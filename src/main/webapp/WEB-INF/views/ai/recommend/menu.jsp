...
<div class="card mb-3">
    <div class="card-header" style="text-align: left;">
        <div class="min-vh-50">
            <form>
            	<h3>메뉴추천</h3>
            	<img src="/resources/image/yum.png" width="10%" style="padding:10px;"/>  메뉴를 선택하세요. 
            	<div style="float: left; width: 100px; padding:10px " >
<!--             	<label>메뉴를 선택하세요.</label> -->
            	</div>
            	<br/>
                <div style="display: flex;" >
                    <select class="form-select" id="yy_eat" onchange="yyEatPrint(this.value);" style="width:300px;" >
                ...
                <form id="dataGo" action="http://192.168.141.11:5000/menu" method="post" >
...
//         console.log("data",data);
    	...
    	$.ajax({
    		// flask와 연결
    		url : 'http://192.168.141.11:5000/menu.ajax',  
    		type : "POST",
    		data : data,
    		dataType : "json",
