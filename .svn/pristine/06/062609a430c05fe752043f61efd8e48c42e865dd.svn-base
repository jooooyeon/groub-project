		...
		<div class="card-body bg-light ">
			<form class="row g-3" modelAttribute="userRegisterVO" action="/admin/account/create" method="post">
				<div class="col-lg-6">
					...
					<input class="form-control" id="jncmpYmd" name="jncmpYmd" type="date" value="" required>
				</div>
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<input class="form-control" id="userNm" name="userNm" type="text" value="이수호" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="userEml">이메일</label>
					<input class="form-control" id="userEml" name="userEml" type="email" value="soohoo@naver.com" required><span id="emailcheck"></span></input>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="userTelno">전화번호</label>
					<input class="form-control" id="userTelno" name="userTelno" type="text" placeholder="숫자만 입력" required value="01045457848" maxlength='11' oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="brthYmd">생년월일</label>
					<input class="form-control" id="brthYmd" name="brthYmd" type="date" value="1995-07-08" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="userZip">우편번호</label>
					<input class="form-control" id="userZip" name="userZip" type="text" value="35208" required>
				</div>
				<div class="col-lg-2">
				...
				<div class="col-lg-12">
					...
					<input class="form-control" id="userAddr" name="userAddr" type="text" value="대전 서구 청사로 189" required>
				</div>
				<div class="col-lg-12">
					<label class="form-label" for="userDaddr">상세주소</label>
					<input class="form-control" id="userDaddr" name="userDaddr" type="text" value="정부대전청사">
				</div>
				...
				<div class="col-lg-6">
					...
					<select class="form-select" id="deptNo" name="deptNo" required>
							...
							<option value="5" selected>개발팀</option>
					</select>
				</div>
				<div class="col-lg-6">
					...
					<select class="form-select" id="jbgdCd" name="jbgdCd" required>
							...
							<option value="JG001" selected>사원</option>
					</select>
				</div>
				<div class="col-lg-6">
					...
					<select class="form-select" id="jbtlCd" name="jbtlCd" required>
							...
							<option value="JT001" selected>팀원</option>
					</select>
				</div>
				<div class="col-lg-6">
				...
				<div class="col-lg-6">
					...
					<select class="form-select" id="mtrscCd" name="mtrscCd" required>
							...
							<option value="MT001" selected>군필</option>
					</select>
				</div>

				<div class="col-lg-6">
					<label class="form-label" for="anslry">연봉</label>
					<input class="form-control" id="anslry" name="anslry" type="number" value="36000000" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="anslryKo"> &nbsp; </label>
					<div class="fs-0" id="anslryKo">삼천육백만원</div>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="bankNm">은행</label>
					<input class="form-control" id="bankNm" name="bankNm" type="text" value="신한은행" required>
				</div>
				<div class="col-lg-6">
					<label class="form-label" for="actNo">계좌번호</label>
					<input class="form-control" id="actNo" name="actNo" type="text" value="100445643334" required>
				</div>
