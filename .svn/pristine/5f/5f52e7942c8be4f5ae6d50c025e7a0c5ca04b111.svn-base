...
public class DraftVO {
	...
	/**
	 * 날짜 데이터를 받아와서 yyyy-MM-dd 형태로 변형 하여 가져옴
	 * @param date 날짜 데이터
	 * @return yyyy-MM-dd 형태의 문자열 날짜 데이터
	 */
	...
	/**
	 * 날짜 데이터를 받아와서 yyyy-MM-dd HH:mm:ss 형태로 변형 하여 가져옴
	 * @param date 날짜 데이터
	 * @return yyyy-MM-dd HH:mm:ss 형태의 문자열 날짜 데이터
	 */
